                        ...
                        <div className="p-8 md:p-12 max-h-[70vh] overflow-y-auto">
                              ...
                              <div className="space-y-6">
                                 ...
                                 <div className="space-y-4">
                                    <div className="grid md:grid-cols-2 gap-6">
                                       <div className="space-y-1 relative">
                                          <input name="fullName" placeholder="Full Name" value={formData.fullName} onChange={handleChange} className={`w-full p-4 bg-gray-50 rounded-xl outline-none focus:ring-2 ${errors.fullName ? 'focus:ring-red-500 border border-red-500' : 'focus:ring-[#0071e3]/20 border border-gray-200'}`} />
                                          <ValidIcon field="fullName" />
                                          {errors.fullName && <p className="text-red-500 text-xs">{errors.fullName}</p>}
                                       </div>
                                       <div className="space-y-1 relative">
                                          <input name="phoneNumber" placeholder="Phone Number" value={formData.phoneNumber} onChange={handleChange} className={`w-full p-4 bg-gray-50 rounded-xl outline-none focus:ring-2 ${errors.phoneNumber ? 'focus:ring-red-500 border border-red-500' : 'focus:ring-[#0071e3]/20 border border-gray-200'}`} />
                           ...
                           <div className="flex justify-between mt-12 pt-8 border-t border-gray-100 gap-4">
                              ...
                              <button
                                 ...
                                 disabled={loading || (step === 0 && (!formData.brand || !formData.model)) || (step === 1 && (!formData.fullName || !formData.phoneNumber || !formData.pickupAddress || !formData.city || !formData.pincode))}
